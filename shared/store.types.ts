...
export const STORE_ITEMS: StoreItem[] = [
  ...
  },
  {
    ...
    category: 'character',
    nameAr: 'الوالد',
    descriptionAr: 'الشيخ الكبير صاحب الحكمة والمكانة',
    price: 10000,
    rarity: 'legendary',
    preview: { bg: 'bg-emerald-950', border: 'border-yellow-300', text: 'text-yellow-100' },
  },
  // ── More variety — women + colored headwear ──────────────────────────────
  {
    id: 'avatar_17',
    category: 'character',
    nameAr: 'الأميرة',
    descriptionAr: 'فتاة بالشيلة الأنيقة — رمز الأناقة',
    price: 350,
    rarity: 'silver',
    preview: { bg: 'bg-pink-950', border: 'border-pink-400', text: 'text-pink-100' },
  },
  {
    id: 'avatar_18',
    category: 'character',
    nameAr: 'الست',
    descriptionAr: 'سيدة بالعباءة والشيلة — وقار وكرامة',
    price: 500,
    rarity: 'silver',
    preview: { bg: 'bg-purple-950', border: 'border-purple-300', text: 'text-purple-100' },
  },
  {
    id: 'avatar_19',
    category: 'character',
    nameAr: 'الفارس النجدي',
    descriptionAr: 'رجل بالشماغ الأحمر — أصل العرب',
    price: 600,
    rarity: 'gold',
    preview: { bg: 'bg-red-950', border: 'border-red-300', text: 'text-red-100' },
  },
  {
    ...
    category: 'character',
    nameAr: 'التاجر',
    descriptionAr: 'تاجر بالغترة الذهبية — صاحب القافلة',
    price: 800,
    rarity: 'gold',
  ...
  },
  {
    ...
    category: 'character',
    nameAr: 'الشاعرة',
    descriptionAr: 'فتاة شامخة بأبيات الشعر',
    price: 1500,
    rarity: 'gold',
    preview: { bg: 'bg-rose-950', border: 'border-rose-300', text: 'text-rose-100' },
  },
  {
    id: 'avatar_22',
    category: 'character',
    nameAr: 'الحكيم',
    descriptionAr: 'شيخ كبير بالغترة البيضاء',
    price: 1200,
    rarity: 'gold',
    preview: { bg: 'bg-stone-900', border: 'border-stone-200', text: 'text-stone-100' },
  },
  // ── More women — 6 distinct styles ────────────────────────────────────────
  {
    id: 'avatar_23',
    category: 'character',
    nameAr: 'الطالبة',
    descriptionAr: 'فتاة جامعية بشيلة عصرية',
    price: 250,
    rarity: 'silver',
    preview: { bg: 'bg-indigo-950', border: 'border-indigo-300', text: 'text-indigo-100' },
  },
  {
    id: 'avatar_24',
    category: 'character',
    nameAr: 'الجدة',
    descriptionAr: 'حنان البيت ورمز الذكريات',
    price: 700,
    rarity: 'gold',
    preview: { bg: 'bg-zinc-900', border: 'border-stone-300', text: 'text-stone-100' },
  },
  {
    id: 'avatar_25',
    category: 'character',
    nameAr: 'المعلمة',
    descriptionAr: 'صانعة الأجيال بأناقتها',
    price: 900,
    rarity: 'gold',
    preview: { bg: 'bg-teal-950', border: 'border-teal-300', text: 'text-teal-100' },
  },
  {
    id: 'avatar_26',
    category: 'character',
    nameAr: 'البدوية',
    descriptionAr: 'بنت الصحراء بزينة الأجداد',
    price: 1100,
    rarity: 'gold',
    preview: { bg: 'bg-amber-950', border: 'border-amber-300', text: 'text-amber-100' },
  },
  {
    id: 'avatar_27',
    category: 'character',
    nameAr: 'الطبيبة',
    descriptionAr: 'علم وعطاء بثوب أبيض',
    price: 1300,
    rarity: 'gold',
    preview: { bg: 'bg-sky-950', border: 'border-sky-300', text: 'text-sky-100' },
  },
  {
    id: 'avatar_28',
    category: 'character',
    nameAr: 'ملكة الذهب',
    descriptionAr: 'تاج من الذهب وجمال أسطوري',
    price: 5000,
    rarity: 'legendary',
    preview: { bg: 'bg-yellow-950', border: 'border-yellow-300', text: 'text-yellow-100' },
  },
